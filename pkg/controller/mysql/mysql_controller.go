...
import (
	...
	myappsv1 "github.com/droot/client-status-demo/pkg/apis/myapps/v1"
...
// +kubebuilder:rbac:groups=myapps.examples.org,resources=mysqls,verbs=get;list;watch;create;update;patch;delete
func (r *ReconcileMySQL) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	if found.Status.AvailableReplicas != instance.Status.Size {
		instance.Status.Size = found.Status.AvailableReplicas
